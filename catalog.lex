...
fn packages() -> List[Pkg] {
  [
    ...
    { name: "lex-loom", layer: Agents, status: Beta, public: true,
      ...
      hero: "" },
    { name: "lex-soft", layer: Agents, status: Beta, public: true,
      summary: "LLM-agent platform: registry, relationship graph, resolver, runner.",
      hero: "" },
    { name: "lex-agent-llm", layer: Agents, status: Runnable, public: true,
      summary: "Brain-skin bridge: run a lex-llm agent loop as a lex-agent Skill (A2A/MCP-reachable).",
      hero: "" },
    { name: "lex-mcp-client", layer: Agents, status: Runnable, public: true,
      summary: "MCP client for lex — connect to an MCP server over HTTP and adapt its tools into lex-llm Tools.",
      hero: "" },
    { name: "lex-jose", layer: Library, status: Runnable, public: true,
      summary: "JOSE for Lex: JWS / JWT / JWK over std.crypto. EdDSA + HMAC today; ES256 + SD-JWT on deck for AP2.",
      hero: "" },
    { name: "lex-x402", layer: Library, status: Beta, public: true,
      summary: "x402 agent payments for Lex: the 402→sign→settle handshake over exact/Solana, EVM, and HTTP.",
      hero: "" },
    { name: "lex-games", layer: Library, status: Runnable, public: true,
      summary: "Capability-gated, verifiable turn games + the arena verifier (replay a trail → score).",
      hero: "" },

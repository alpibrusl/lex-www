...
New here? Read the [manifesto](https://lexlang.org) · install [lex-lang](https://github.com/alpibrusl/lex-lang/releases).
...
- [lex-cli](https://github.com/alpibrusl/lex-cli) — CLI framework for Lex: arg parsing, ACLI output, config, authenticated HTTP client.  _(beta)_
- [lex-spec](https://github.com/alpibrusl/lex-spec) — Capability-precondition + spec DSL: Spec ADT, evaluator, property checks, SMT-LIB export.  _(beta)_

## Libraries — horizontal building blocks

- [lex-web](https://github.com/alpibrusl/lex-web) — HTTP + WebSocket framework: actor-model concurrency; one schema drives every artifact.  _(beta)_
- [lex-schema](https://github.com/alpibrusl/lex-schema) — Pydantic-style runtime validation, codegen, and schema utilities for Lex.  _(beta)_
- [lex-orm](https://github.com/alpibrusl/lex-orm) — Typed query builder, migration runner, and live std.sql driver built on lex-schema.  _(beta)_
...
- [lex-llm](https://github.com/alpibrusl/lex-llm) — Pure-Lex LLM-agent runtime: provider abstraction, tool-call loop, structured outputs.  _(beta)_
- [lex-mcp](https://github.com/alpibrusl/lex-mcp) — MCP stdio server bridging lex-agent Skills to MCP JSON-RPC.  _(beta)_
...
- [lex-jobs](https://github.com/alpibrusl/lex-jobs) — SQL-backed durable background job queue: enqueue, pull, dispatch, ack, retries.  _(beta)_
...
- [lex-agent](https://github.com/alpibrusl/lex-agent) — Pure-Lex Google A2A protocol: AgentCard, JSON-RPC, Task lifecycle, SSE streaming.  _(beta)_
...
- [lex-code](https://github.com/alpibrusl/lex-code) — Lex-native coding assistant built entirely in the Lex ecosystem.  _(beta)_
- [lex-loom](https://github.com/alpibrusl/lex-loom) — Multi-agent sprint cycles built on lex-soft (design stage).  _(alpha)_

## Finance

- [lex-finance](https://github.com/alpibrusl/lex-finance) — Agent-native finance software stack for the Lex language.  _(beta)_
...
- [lex-trade](https://github.com/alpibrusl/lex-trade) — Pre-trade order validation for the Lex language.  _(beta)_
- [lex-sor](https://github.com/alpibrusl/lex-sor) — Smart order routing for the Lex finance stack.  _(beta)_
- [lex-fix](https://github.com/alpibrusl/lex-fix) — FIX 4.4 protocol adapter for the Lex language.  _(beta)_
...
- [lex-oms-agent](https://github.com/alpibrusl/lex-oms-agent) — LLM-backed autonomous trading agents with compile-time effect isolation.  _(beta)_

...
- [lex-device-identity](https://github.com/alpibrusl/lex-device-identity) — Platform-signed device certificates + offline signed-reading verification — the tamper-evident trail starts at the device.  _(runnable)_
- [lex-slim](https://github.com/alpibrusl/lex-slim) — Lex client for SLIM (AGNTCY) multicast agent messaging — multi-party agent comms via a SLIM-node sidecar bridge.  _(alpha)_
- [lex-jose](https://github.com/alpibrusl/lex-jose) — JOSE for Lex: JWS / JWT / JWK over std.crypto. EdDSA + HMAC today; ES256 + SD-JWT on deck for AP2.  _(runnable)_
- [lex-x402](https://github.com/alpibrusl/lex-x402) — x402 agent payments for Lex: the 402→sign→settle handshake over exact/Solana, EVM, and HTTP.  _(beta)_
- [lex-games](https://github.com/alpibrusl/lex-games) — Capability-gated, verifiable turn games + the arena verifier (replay a trail → score).  _(runnable)_
...
- [lex-arena](https://github.com/alpibrusl/lex-arena) — Where Lex agents play: a lobby, N-player games, and the Magentic Bazaar — a governed agent marketplace, replay-verified by lex-games.  _(runnable)_
- [lex-loom](https://github.com/alpibrusl/lex-loom) — Multi-agent sprint cycles built on lex-soft (design stage).  _(beta)_
- [lex-soft](https://github.com/alpibrusl/lex-soft) — LLM-agent platform: registry, relationship graph, resolver, runner.  _(beta)_
- [lex-agent-llm](https://github.com/alpibrusl/lex-agent-llm) — Brain-skin bridge: run a lex-llm agent loop as a lex-agent Skill (A2A/MCP-reachable).  _(runnable)_
- [lex-mcp-client](https://github.com/alpibrusl/lex-mcp-client) — MCP client for lex — connect to an MCP server over HTTP and adapt its tools into lex-llm Tools.  _(runnable)_
...
- [lex-ocpp](https://github.com/alpibrusl/lex-ocpp) — OCPP library for Lex: v1.6 and v2.0.1 framing and handler dispatch.  _(runnable)_
- [lex-ocpi](https://github.com/alpibrusl/lex-ocpi) — OCPI 2.2.1 library for Lex: CPO / eMSP / PTP role endpoints.  _(runnable)_
